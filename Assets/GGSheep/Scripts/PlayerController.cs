...
public class PlayerController : MonoBehaviour 
{
    ...
    public float forwardBackwardAngle = 45.0f;

    public TileMoverEventTypes lastType = TileMoverEventTypes.None;
	...
	float UpdateMovement ()
	{
        ...
        if(isMoving)
        {
            ...
            else if(absAngle > (180.0f-forwardBackwardAngle))
            {
        ...
        {
            lastType = TileMoverEventTypes.None;
        }
